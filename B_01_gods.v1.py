...
class Play:
    ...
    def __init__(self, _amount_):
        ...
        for item in range(0, 4):
            self.power_button = Button(self.power_frame, font=("Arial", 12), text="Power Name", width=15, bg="#008cff")
    ...
    def next_round(self):
        ...
        rounds_wanted = self.rounds_asked.get()
    ...
    # self.round_power_list, median = get_rounds_power()
        ...
        for count, item in enumerate(self.power_button_ref):
            item.config(fg=self.power_list[count][2],
